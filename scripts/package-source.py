...
root_files = ['README.md','START_HERE.md','PRD.md','design.md','architecture.md','package.json','package-lock.json','requirements.txt','pytest.ini','Dockerfile','compose.yaml','start.ps1','tsconfig.json','vite.config.ts','vitest.config.ts','index.html','.env.example','.gitignore','.dockerignore']
